...
{
  keymap['y'] = Controller::MapTarget( ODEAxleConnector::CTRL_TORQUE, 1.0 );
  keymap['h'] = Controller::MapTarget( ODEAxleConnector::CTRL_TORQUE, -1.0 );
}
...
int main( int argc, char * argv[] )
{
  ...
  */
  ...
  viewport.addActor( dynamic_pointer_cast<Actor>(object2),
                     &ssKeymap );
  dynamic_pointer_cast<FloatingActor>(object2)->setAutoRoll( false );
  ...
  */
  ...
  // light
  shared_ptr<Object> lightObj
    (new Object( Object::Params( new InertiaLocator( makeVector3d( 2.0, 2.0, -3.0 ) ),
  ...
  shared_ptr<FloatingActor> camTarget( new FloatingActor() );
