...
{
  keymap['t'] = Controller::MapTarget( ODEUniversalConnector::CTRL_TORQUE_X, 0.5 );
  keymap['g'] = Controller::MapTarget( ODEUniversalConnector::CTRL_TORQUE_X, -0.5 );
  keymap['y'] = Controller::MapTarget( ODEUniversalConnector::CTRL_TORQUE_Y, 0.5 );
  keymap['h'] = Controller::MapTarget( ODEUniversalConnector::CTRL_TORQUE_Y, -0.5 );
}
        ...
        ( Connector( *this, Connector::Any,
                     ...
                     ( makeVector3d( 0.0, 2.0, 0.0 ),
                       ...
                       ( makeVector3d( 0.0, 0.0, -1.0 ),
                         makeVector3d( 0.0, 1.0, 0.0 ) ))),
          ODEMotorAxisParams( 1.0, -0.9 * M_PI, 0.9 * M_PI, 0.5 ),
  ...
  public Object
{
 public:
   ...
   * Constructs a new test object with a connector at the tip of the x axis
   */
  TestObjectUniversal( const Object::Params & objectParams ) :
    Object( objectParams )
  {
    // create and insert the x axis connector
    connectors[CONN_X_AXIS_TIP] = shared_ptr<Connector>
...
int main( int argc, char * argv[] )
{
  ...
  Object * universalObject = new TestObjectUniversal
    ( Object::Params
      ( new ODELocator( makeVector3d( 0.0, 1.0, -10.0 ) ),
        ...
        ( sptr( new shapes::Scaled( makeVector3d( 2.0, 2.0, 2.0 ),
                                    sptr( new shapes::Basis ))),
          &whiteMat )));
  world.addObject( universalObject );
  ...
  middleObject->getConnector(MiddleObject::CONN_Y_AXIS_TIP).connect
    ( universalObject->getConnector(TestObjectUniversal::CONN_X_AXIS_TIP) );
