 ...
 * an ODEFixedConnector. The axle connector and the middle object (which is a
  ...
  public Object
{
 public:
   ...
   * Constructs a new test object with a connector at the tip of the x axis
   */
  TestObjectFixed( const Object::Params & objectParams ) :
    Object( objectParams )
  {
    // create and insert the x axis connector
    connectors[CONN_X_AXIS_TIP] = shared_ptr<Connector>
...
{
  if( argc != 3 ) {
    cout << "Usage: " << argv[0] << " <fixed erp> <fixed cfm>" << endl;
    return 1;
  }
  ...
  Object * object5 = new TestObjectFixed
    ( Object::Params
  ...
  object2->getConnector(TestObjectSs::CONN_Y_AXIS_TIP).connect
    ( object5->getConnector(TestObjectFixed::CONN_X_AXIS_TIP) );
