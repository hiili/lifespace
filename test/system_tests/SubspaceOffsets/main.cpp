...
{
public:
  TrackerBall( const Object::Params & params ) :
    Object( params ) {}
  
  void step()
  {
    cout << "tb: own y: " << getLocator()->getLoc()(DIM_Y)
         << " directworld y: " << getLocator()->getDirectWorldLocator()->getLoc()(DIM_Y)
