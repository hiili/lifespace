 ...
 * an ODEBallConnector. The axle connector and the middle object (which is a
...
int main( int argc, char * argv[] )
{
  ...
  Object * object5 = new TestObjectBall
    ( Object::Params
  ...
  object2->getConnector(TestObjectSs::CONN_Y_AXIS_TIP).connect
    ( object5->getConnector(TestObjectBall::CONN_X_AXIS_TIP) );
