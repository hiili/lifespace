 ...
 */
#ifndef LS_S_EVENT_HPP
#define LS_S_EVENT_HPP
...
namespace lifespace {
  ...
  /** An extended EventHost, which allows listeners to use overloading instead
      of switching to parse the event types. This is the preferred EventHost
      type until moving to libsigc++. */
